...
project_name='DAPO_MATH1.5'
eval_temperature=0.6
exp_name='1.1-0.8-0.4tokens-onpolicy'
...
# Paths
MODEL_DIR=//opt/tiger/qwen1.5-math
...
TEST_FILE=${TEST_FILE:-"${RAY_DATA_HOME}/eval-box-aime256-amc32.parquet"}
...
ray job submit --no-wait --runtime-env="${RUNTIME_ENV}" \
    ...
    trainer.project_name="${project_name}-EVAL" \
    trainer.experiment_name="${exp_name}-Temp${eval_temperature}" \
