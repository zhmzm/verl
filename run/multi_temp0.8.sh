...
TRAIN_FILE=${TRAIN_FILE:-"/mnt/bn/llm-liufangxu/mlx/users/haomin/data/dapo-box/dapo-math-17k-box.parquet"}
TEST_FILE=${TEST_FILE:-"/mnt/bn/llm-liufangxu/mlx/users/haomin/data/dapo-box/aime-2024-box.parquet"}
